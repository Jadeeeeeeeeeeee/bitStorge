...
function Home() {
    ...
    <div className="h-17/20 w-screen absolute flex md:flex-row flex-col items-center">
          <div className="md:w-6/10 w-10/10 flex flex-col gap-y-2 md:gap-y-5 md:mb-40 items-center md:mt-40 z-10">
            ...
            <img src={Ilu} className='md:hidden visible h-80 w-80 z-0 md:h-7/10 userDrag'/>
            <a href="" className='mt-20 h-1/10 w-1/2 md:h-1/10 md:w-3/10 lg:w-2/10 lg:text-20/10 bg-DocsPink text-center flex justify-center items-center mb-14 pb-5 pt-5 rounded-full sm:rounded-full lg:rounded-full xl:rounded-full 3xl:rounded-full md:rounded-full text-white text-15/10'>docs</a>
          </div>
          <img src={Ilu} className="hidden md:block h-1/2 z-0 md:h-7/10 mb-20 userDrag" />
    </div>
    </>);
}
