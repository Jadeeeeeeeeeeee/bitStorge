...
function PricingCard(props) {
    ...
    <div className="bg-white md:w-1/5 sm:w-3/10 w-5/10 md:h-8/10 rounded-4xl flex flex-col justify-center items-center">
        ...
        <div className=" w-full h-6/10 flex flex-col items-center mb-10">
            <p className="w-9/10 h-fit text-10/10 md:text-15/10 leading-normal lg:text-20/10 mt-5"> {props.desc}</p>
            <p className="w-9/10 h-fit text-10/10 md:text-15/10 leading-normal lg:text-20/10"> {props.desc2}</p>
            <p className="w-9/10 h-fit text-10/10 md:text-15/10 leading-normal lg:text-20/10"> {props.desc3}</p>
            <p className="w-9/10 h-fit text-10/10 md:text-15/10 leading-normal lg:text-20/10"> {props.desc5}</p>
            <p className="w-9/10 h-fit text-10/10 md:text-15/10 leading-normal lg:text-20/10"> {props.desc4}</p>
        </div>
