...
function PricingCard(props) {
    return(<>
    <div className="bg-white md:w-1/5 sm:w-3/10 w-5/10 md:h-8/10 rounded-3xl flex flex-col justify-center items-center">
        <h1 className="w-10/10 h-3/20  text-center flex items-center justify-center md:text-20/10 p-2 md:p-0">{props.plan}</h1>
        ...
        <button className="w-6/10 h-3/20 md:h-2/10 rounded-3xl bg-buyButton text-white text-10/10 md:text-15/10 mb-3 md:mb-4">Buy</button>
    </div>
    </>);
}
