...
function SideBar() {
    ...
    <img src={Logo} className='sm:ml-5 sm:h-20 lg:h-20 3xl:w-32 3xl:h-32 md:h-20 size-14 sm:w-20 lg:w-20 md:w-20 ml-2sm:ml-10 lg:ml-10 md:ml-10 shrink-0 grow-0'/>
